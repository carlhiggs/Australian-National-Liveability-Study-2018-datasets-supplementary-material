...
COMMENT ON COLUMN li_2018_mb_indicators.mb_code_2016 IS $$City name$$;
COMMENT ON COLUMN li_2018_mb_indicators.study_region IS $$Mesh Block (ASGS 2016) identifier$$;
